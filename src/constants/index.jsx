...
export const CognizantProjectExperience = [
  {
    ...
    description:
    "• Developed and maintained reusable React components for the Directv product & offer section, ensuring a consistent and efficient user interface. \n• Enhanced existing React features and implemented bug fixes, resulting in a 10% reduction in UI-related bugs. \n• Managed the front-end deployment process, ensuring seamless and efficient delivery of React applications. \n• Utilized Dynatrace, ServiceNow, and Quantum Metric to monitor and optimize React application performance and identify front-end issues."
  },
  {
    client: "Verizon",
